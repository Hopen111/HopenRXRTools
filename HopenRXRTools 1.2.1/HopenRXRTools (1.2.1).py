...
--If You Still Cannot Find The DOT Number, You Can Type "UNKNOWN" In Full Caps
...
for i in range(Dotdigits):
    ...
    if DotDigitSorted == ",": #Adds Comma
        ...
        dotcommacheck = "DOTS"
    dotlist.append("http://www.rxrsignals.com/Graphics/DOT/"+DotDigitSorted+".png>")
...
for i in range(dotlistlength): #Should Create HTML
    ...
    dotcommasizefix = "13"
    if dotsort == "http://www.rxrsignals.com/Graphics/DOT/Comma.png>":
    	dotcommasizefix = "5"
...
alt="" src="http://www.rxrsignals.com/Graphics/DOT/"""+dotcommacheck+""".png"><img style="width: 10px; height: 20px;" alt="" src="http://www.rxrsignals.com/Graphics/DOT/Blank.png"> """+dothtml+"""</font></font></strong></td>
</tr>"""
if dot == "":
    dothtmlblank = ""
if dot == "UNKNOWN" or dot == "Unknown" or dot == "unknown" or dot == "idk" or dot == "N/A" or dot == "n/a":
    dothtmlblank = """<tr>
<td style="vertical-align: middle; text-align: center;"><strong><font
...
for i in range(mplistlength): #Should Create HTML
    ...
    if mpsort == "http://www.rxrsignals.com/Graphics/Milepost_Numbers/Decimal.PNG>":
    	mpdecimalsizefix = "8"
    if mpsort == "http://www.rxrsignals.com/Graphics/Milepost_Numbers/Comma.PNG>":
    	mpdecimalsizefix = "7"
