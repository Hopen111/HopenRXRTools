...
if os.path.exists("Relay_Bungalow/Delete This Please.txt"):
  os.remove("Relay_Bungalow/Delete This Please.txt")
...
if os.path.exists("Action_Shots/Delete This Please.txt"):
  os.remove("Action_Shots/Delete This Please.txt")

if os.path.exists("Median_Signals/Northern_Median_Signal/Delete This Please.txt"):
  os.remove("Median_Signals/Northern_Median_Signal/Delete This Please.txt")

if os.path.exists("Median_Signals/Southern_Median_Signal/Delete This Please.txt"):
  os.remove("Median_Signals/Southern_Median_Signal/Delete This Please.txt")

if os.path.exists("Median_Signals/Eastern_Median_Signal/Delete This Please.txt"):
  os.remove("Median_Signals/Eastern_Median_Signal/Delete This Please.txt")

if os.path.exists("Median_Signals/Western_Median_Signal/Delete This Please.txt"):
  os.remove("Median_Signals/Western_Median_Signal/Delete This Please.txt")

if os.path.exists("Pedestrian_Signals/Northern_Ped_Signal/Delete This Please.txt"):
  os.remove("Pedestrian_Signals/Northern_Ped_Signal/Delete This Please.txt")

if os.path.exists("Pedestrian_Signals/Southern_Ped_Signal/Delete This Please.txt"):
  os.remove("Pedestrian_Signals/Southern_Ped_Signal/Delete This Please.txt")

if os.path.exists("Pedestrian_Signals/Eastern_Ped_Signal/Delete This Please.txt"):
  os.remove("Pedestrian_Signals/Eastern_Ped_Signal/Delete This Please.txt")

if os.path.exists("Pedestrian_Signals/Western_Ped_Signal/Delete This Please.txt"):
  os.remove("Pedestrian_Signals/Western_Ped_Signal/Delete This Please.txt")
